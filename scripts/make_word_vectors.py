...
model_skipgram = gensim.models.Word2Vec(sentences, min_count = 1, size = 300, sg = 1, window = 4)
print ("Training skipgram done...")

model_cbow = gensim.models.Word2Vec(sentences, min_count = 1, size = 300, sg = 0, window=4 )
...
model_skipgram.save(OUTPUT_DIR+'/skipgram_300')
model_cbow.save(OUTPUT_DIR+'/cbow_300')
